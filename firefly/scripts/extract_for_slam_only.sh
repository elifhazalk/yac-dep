...
echo ">>> extracting slam related archives to target"

if [ "$#" -ne 3 ]; then
    echo "Usage: $0 {Download Target DIR} {SLAM - Deploy Target DIR} {SavedMaps - Deploy Target DIR}" >&2
  exit 1
fi
